      ...
      <div className="relative w-full max-w-md">
        <div className="rounded-2xl border border-slate-200/80 bg-white p-8 shadow-md">
          ...
          <div className="flex flex-col items-center text-center mb-8">
            ...
            <p className="mt-1 text-sm text-slate-500">Sign in to manage leave, approvals, and schedules.</p>
          </div>
          ...
          >
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor="remember_me" className="ml-2 block text-sm font-semibold text-slate-600 select-none">
