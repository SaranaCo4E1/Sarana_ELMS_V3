  ...
  return (
    <div className="relative min-h-screen bg-slate-50/40 text-neutral-800 antialiased selection:bg-orange-500 selection:text-white">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        <div className="absolute top-0 left-0 -translate-x-1/3 -translate-y-1/3 h-[500px] w-[500px] rounded-full bg-gradient-to-br from-orange-400/8 to-amber-500/8 blur-3xl"></div>
        <div className="absolute bottom-0 right-0 translate-x-1/3 translate-y-1/3 h-[500px] w-[500px] rounded-full bg-gradient-to-br from-orange-400/5 to-amber-500/5 blur-3xl"></div>
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-12 sm:py-20">
        ...
        <div className="rounded-xl border border-neutral-200 bg-white p-6 sm:p-10 shadow-premium-lg space-y-8">
          <section className="space-y-3">
            ...
            <div className="text-sm font-medium text-neutral-500 leading-relaxed pl-8 space-y-2.5">
