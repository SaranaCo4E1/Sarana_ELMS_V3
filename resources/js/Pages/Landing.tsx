  ...
  return (
    <div className="relative min-h-screen bg-slate-50/40 text-neutral-800 antialiased selection:bg-orange-500 selection:text-white">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        ...
        <div className="absolute top-[35%] right-0 translate-x-1/2 -translate-y-1/2 h-[600px] w-[600px] rounded-full bg-gradient-to-br from-orange-500/5 to-amber-600/5 blur-3xl"></div>
        <div className="absolute bottom-0 left-[15%] translate-y-1/2 h-[400px] w-[400px] rounded-full bg-gradient-to-tr from-orange-400/5 to-amber-400/5 blur-3xl"></div>
      </div>
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 sm:px-8">
          ...
          <div className="flex items-center gap-3 select-none">
            ...
            <div>
              ...
              <div className="text-[9px] font-normal text-neutral-400 uppercase tracking-wider mt-1">Leave Portal</div>
            </div>
          </div>
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-6 pt-16 pb-12 sm:px-8 sm:pt-24 lg:grid lg:grid-cols-12 lg:gap-12">
        <div className="lg:col-span-6 flex flex-col justify-center">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-neutral-900 sm:text-5xl lg:text-5.5xl leading-[1.12]">
          ...
          <p className="mt-6 max-w-lg text-sm sm:text-base font-normal leading-relaxed text-neutral-500">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            ...
            <a 
              href="#preview" 
              className="flex h-12 items-center justify-center gap-1.5 rounded-lg border border-neutral-200 bg-white px-6 font-medium text-neutral-600 hover:bg-neutral-50 active:scale-98 transition-all shadow-premium-sm"
            >
              Interactive Demo
            </a>
          </div>
        ...
        <div className="lg:col-span-6 mt-12 lg:mt-0 relative flex justify-center items-center">
          <div className="w-full max-w-lg rounded-xl border border-neutral-200 bg-white shadow-premium-lg overflow-hidden animate-fade-in">
            ...
            <div className="flex items-center justify-between border-b border-neutral-100 bg-neutral-50/50 px-5 py-3">
              ...
              <div className="rounded-md bg-neutral-200/50 px-4 py-1 text-[10px] font-medium text-neutral-500">
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div className="rounded-lg border border-orange-100 bg-orange-50/30 p-3 shadow-premium-sm">
                  <div className="text-[9px] font-medium uppercase tracking-wider text-orange-800">Annual Leave</div>
                  <div className="mt-1.5 flex items-baseline gap-1">
                    <span className="text-lg font-medium text-orange-950">14.5</span>
                    <span className="text-[9px] font-normal text-orange-700">days left</span>
                  </div>
                ...
                <div className="rounded-lg border border-amber-100 bg-amber-50/30 p-3 shadow-premium-sm">
                  <div className="text-[9px] font-medium uppercase tracking-wider text-amber-800">Sick Leave</div>
                  <div className="mt-1.5 flex items-baseline gap-1">
                    <span className="text-lg font-medium text-amber-950">8.0</span>
                    <span className="text-[9px] font-normal text-amber-700">days left</span>
                  </div>
                ...
                <div className="rounded-lg border border-neutral-200 bg-neutral-50/50 p-3 shadow-premium-sm">
                  <div className="text-[9px] font-medium uppercase tracking-wider text-neutral-500">Unpaid Leave</div>
                  <div className="mt-1.5 flex items-baseline gap-1">
                    <span className="text-lg font-medium text-neutral-800">0.0</span>
                    <span className="text-[9px] font-normal text-neutral-400">days used</span>
                  </div>
              ...
              <div className="rounded-lg border border-neutral-200/80 bg-white p-3.5 shadow-premium-sm">
                ...
                <div className="mt-2.5 space-y-2.5 text-[11px] leading-relaxed">
                  ...
                  <div className="flex justify-end">
                    <div className="max-w-[85%] rounded-lg bg-orange-50 text-orange-800 border border-orange-100/40 px-3 py-1.5 font-medium">
                      ...
                      <div className="flex justify-start animate-fade-in">
                        <div className="max-w-[90%] space-y-2">
                          ...
                          {chatStep === 'initial' && (
                            <div className="flex items-center gap-1.5">
                              <button 
                                className="rounded-md bg-orange-600 hover:bg-orange-700 px-2.5 py-1 text-[9px] font-medium text-white transition-all cursor-pointer shadow-premium-sm"
                                onClick={() => setChatStep('draft')}
                              >
                                Yes, draft it
                              </button>
                              <button className="rounded-md bg-white border border-neutral-200/80 hover:bg-neutral-50 px-2 py-1 text-[9px] font-medium text-neutral-600 transition-all cursor-pointer shadow-premium-sm">
                                No, thank you
                              </button>
                            </div>
                          )}
                      ...
                      {chatStep !== 'initial' && (
                        <div className="flex justify-start animate-fade-in">
                          <div className="max-w-[95%] space-y-2">
                            <div className="rounded-lg bg-neutral-50/60 border border-neutral-200/50 p-4 text-neutral-600 font-medium space-y-3.5 text-left shadow-premium-sm">
                              <div className="flex items-center gap-2 border-b border-neutral-100 pb-2">
                                <Bot size={14} className="text-orange-600" />
                                <span className="font-medium text-neutral-800 text-[10px] uppercase tracking-wider">Leave Draft Ready</span>
                              </div>
                              
                              <div className="grid grid-cols-3 gap-2">
                                <div className="rounded-lg border border-neutral-200 bg-white p-2.5">
                                  <div className="text-[8px] font-medium uppercase tracking-wider text-neutral-400">Type</div>
                                  <div className="mt-1 font-medium text-[10px] text-neutral-800">Annual</div>
                                </div>
                                <div className="rounded-lg border border-neutral-200 bg-white p-2.5">
                                  <div className="text-[8px] font-medium uppercase tracking-wider text-neutral-400">Start</div>
                                  <div className="mt-1 font-medium text-[10px] text-neutral-800">Jun 15</div>
                                </div>
                                <div className="rounded-lg border border-neutral-200 bg-white p-2.5">
                                  <div className="text-[8px] font-medium uppercase tracking-wider text-neutral-400">End</div>
                                  <div className="mt-1 font-medium text-[10px] text-neutral-800">Jun 19</div>
                                </div>
                              </div>

                              <div className="rounded-lg border border-neutral-200 bg-white p-2.5">
                                <div className="text-[8px] font-medium uppercase tracking-wider text-neutral-400">Application Note</div>
                              ...
                              {chatStep === 'draft' ? (
                                <button
                                  ...
                                  className="w-full rounded-lg bg-orange-600 hover:bg-orange-700 px-4 py-2 text-[10px] font-medium text-white transition-all cursor-pointer shadow-premium-sm flex items-center justify-center gap-1.5"
                                >
                                  Submit Request
                                </button>
                              ) : (
                                <div className="text-center py-2 text-[10px] font-medium text-orange-700 bg-orange-50 rounded-lg border border-orange-100 flex items-center justify-center gap-1.5 animate-fade-in">
                                  <CheckCircle2 size={12} className="text-orange-600" /> Submitted Successfully!
                                </div>
                              )}
                            </div>
                          </div>
              ...
              <div className="rounded-lg border border-neutral-200 bg-white p-3 shadow-premium-sm">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-[10px] font-medium uppercase tracking-wider text-neutral-500">Upcoming Schedule</span>
                ...
                {chatStep === 'submitted' && (
                  <div className="flex flex-row items-center justify-between gap-2 flex-wrap border-t border-neutral-100 py-2.5 text-xs animate-fade-in">
                    <div className="flex items-center gap-2">
                       ...
                       <div>
                         <div className="font-medium text-neutral-800">Summer Vacation</div>
      ...
      <section id="features" className="relative z-10 border-t border-b border-neutral-200/40 bg-white py-20 sm:py-24">
        <div className="mx-auto max-w-7xl px-6 sm:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-3 text-3xl font-medium tracking-tight text-neutral-900 sm:text-4xl">
          ...
          <div className="mx-auto mt-16 max-w-5xl grid grid-cols-1 gap-8 sm:grid-cols-3">
            ...
            {/* Feature 2 */}
            <div className="relative rounded-xl border border-neutral-200 bg-[#fafbfa]/40 p-6.5 shadow-premium-sm transition-all hover:bg-white hover:shadow-premium-md group">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-amber-600 text-white shadow-md shadow-amber-600/10 group-hover:scale-105 transition-all">
                <CalendarDays size={20} />
              </div>
              <h3 className="mt-5 text-sm font-medium text-neutral-900">Interactive Team Calendars</h3>
              <p className="mt-2.5 text-xs font-medium leading-relaxed text-neutral-500">
            ...
            {/* Feature 3 */}
            <div className="relative rounded-xl border border-neutral-200 bg-[#fafbfa]/40 p-6.5 shadow-premium-sm transition-all hover:bg-white hover:shadow-premium-md group">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-orange-600 text-white shadow-md shadow-orange-600/10 group-hover:scale-105 transition-all">
                <ClipboardCheck size={20} />
              </div>
              <h3 className="mt-5 text-sm font-medium text-neutral-900">Smart Leave Routing</h3>
              <p className="mt-2.5 text-xs font-medium leading-relaxed text-neutral-500">
      ...
      <section id="preview" className="relative z-10 py-20 sm:py-24">
        <div className="mx-auto max-w-7xl px-6 sm:px-8">
          <div className="mx-auto max-w-2xl text-center mb-12">
            ...
            <h2 className="mt-3.5 text-3xl font-medium tracking-tight text-neutral-900 sm:text-4xl">
          ...
          <div className="mx-auto max-w-4xl rounded-xl border border-neutral-200 bg-white p-6 shadow-premium-lg relative overflow-hidden">
            {/* View Selector Tabs */}
            <div className="flex border-b border-neutral-200 pb-4 justify-between items-center flex-wrap gap-4">
              <div className="grid grid-cols-2 gap-2 w-full sm:w-auto sm:flex sm:items-center">
                <button
                  onClick={() => setActiveTab('staff')}
                  className={`flex items-center justify-center sm:justify-start gap-2 rounded-lg px-4 py-2 text-xs font-medium transition-all cursor-pointer ${
                    activeTab === 'staff'
                      ? 'bg-orange-600 text-white shadow-premium-sm'
            ...
            <div className="mt-6">
              {activeTab === 'staff' ? (
                <div className="space-y-6 animate-fade-in">
                  <div className="flex flex-col md:flex-row justify-between gap-4">
                    ...
                    <div className="flex gap-2">
                      <span className="rounded-lg border border-neutral-200 bg-neutral-50/50 px-3.5 py-1.5 text-xs font-medium text-neutral-700 flex items-center gap-1.5">
                        Role: Staff
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="rounded-lg border border-neutral-200/60 bg-white p-4.5 shadow-premium-sm">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-xs font-medium text-neutral-500">
                      ...
                      {!mockRequestApproved && (
                        <button
                          onClick={() => setActiveTab('manager')}
                          className="rounded-md bg-orange-600 hover:bg-orange-700 px-3.5 py-2 text-[11px] font-medium text-white flex items-center gap-1 shrink-0 select-none self-start sm:self-center shadow-md shadow-orange-600/10 cursor-pointer active:scale-98 transition-all"
                        >
                ...
                <div className="space-y-6 animate-fade-in">
                  ...
                  {mockRequestApproved ? (
                    <div className="rounded-lg border border-dashed border-neutral-200 bg-neutral-50/40 p-8 text-center animate-fade-in">
                      <div className="mx-auto flex h-9 w-9 items-center justify-center rounded-full bg-orange-50 text-orange-600 mb-3 border border-orange-100">
                        <CheckCircle2 size={18} />
                      </div>
                      <h5 className="text-xs font-medium text-neutral-800">Leave approval completed!</h5>
                      ...
                      <button
                        ...
                        className="mt-4 rounded-md border border-neutral-200 bg-white px-3 py-1.5 text-[10px] font-medium text-neutral-600 hover:bg-neutral-50 transition-colors shadow-xs"
                      >
                        Reset Demo
                      </button>
                    </div>
                  ) : (
                    <div className="rounded-lg border border-neutral-200 bg-neutral-50/30 p-4.5 space-y-3.5 animate-fade-in">
                      <div className="flex flex-col xs:flex-row xs:items-center justify-between gap-2">
                        <div className="flex items-center gap-2">
                          <div className="flex h-7.5 w-7.5 items-center justify-center rounded-md bg-orange-100 font-medium text-orange-800 text-[10px]">
                            SE
                          </div>
                          <div>
                            <div className="text-xs font-medium text-neutral-800">Software Engineer</div>
        ...
        <div className="mx-auto max-w-3xl px-6 sm:px-8">
          ...
          <div className="space-y-4">
            {faqs.map((faq, idx) => (
              <div 
                key={idx} 
                className="rounded-xl border border-neutral-200 bg-white shadow-premium-sm overflow-hidden transition-all"
              >
                <button
                  onClick={() => toggleFaq(idx)}
                  className="flex w-full items-center justify-between p-5 text-left font-medium text-neutral-800 hover:bg-neutral-50/50 transition-colors"
                >
                  <span className="text-sm font-medium text-neutral-800 pr-4">{faq.q}</span>
                  <div className="shrink-0 rounded-md bg-neutral-100 p-1 text-neutral-500">
        ...
        <div className="mx-auto max-w-7xl px-6 text-center sm:px-8">
          ...
          <div className="mt-16 border-t border-neutral-200/60 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-[10px] text-neutral-400 font-medium uppercase tracking-wider">
            ...
            <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 md:justify-end">
              ...
              <Link href="/terms" className="hover:text-orange-700 transition-colors">Terms of Service</Link>
              <Link href="/support" className="hover:text-orange-700 transition-colors">Support Desk</Link>
            </div>
          </div>
        </div>
      </section>
