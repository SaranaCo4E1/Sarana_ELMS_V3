            ...
            {filtered.map((request) => (
              <div key={request.id} className="grid gap-6 p-6 lg:grid-cols-[1fr_320px]">
                ...
                <div className="space-y-4">
                  ...
                  {request.reason ? (
                    <p className="pre-wrap-anywhere max-w-2xl rounded-lg border border-neutral-200/60 bg-neutral-50/20 p-3.5 text-sm leading-relaxed text-neutral-600 italic shadow-premium-sm">
                      "{request.reason}"
                    </p>
                  ) : (
                    ...
                    {(request.attachments ?? []).map((attachment) => {
                      ...
                      return preview ? (
                        <button
                          ...
                          className="inline-flex max-w-full flex-wrap items-center gap-1.5 rounded-lg bg-white border border-neutral-200 px-3.5 py-1.5 text-sm font-medium text-neutral-600 transition-all hover:bg-neutral-50 hover:border-neutral-300 hover:text-neutral-800 shadow-premium-sm cursor-pointer animate-fade-in"
                          type="button"
                        >
